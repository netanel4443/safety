...
class ImageOptionsDialog : GenericRecyclerViewDialogFragment<TextViewVhCell>() {
...
//                    val items = it.currentState.createFindingFragmentState.imageOptionsRvItems
                    val items = it.createFindingFragmentState.imageOptionsRvItems
                    submitList(items)
                }
            }
        }
